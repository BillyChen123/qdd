...
export type ConcludeStoryEvidenceRole = 'core' | 'bridge' | 'validation' | 'boundary' | 'context' | 'supplementary' | 'excluded';
...
export interface ConcludeStoryPlanAuditViolation {
    code: 'invalid-schema' | 'provenance-leak' | 'execution-language' | 'missing-claim-reference' | 'numeric-fidelity' | 'claim-safety' | 'invalid-leading-claim' | 'invalid-transition' | 'invalid-evidence-role' | 'invalid-emphasis-profile' | 'unsupported-workflow-story';
