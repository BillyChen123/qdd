...
async function collectDataReadPaths(projectRoot) {
...
async function collectResolvedSkillReadPaths(projectRoot, skillIds) {
...
export async function buildInstructions(projectRoot, id) {
