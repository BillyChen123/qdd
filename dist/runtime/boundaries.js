...
import { mergeBoundaryStateIntoEvolution, readEvolutionState, renderResearchMapHtml, toBoundaryState, writeEvolutionState, } from './evolution.js';
import { readMarkdownFrontmatter, readYamlFile } from './store.js';
...
export function scoreBoundaryTargets(state, requestedTargetIds, mode) {
    ...
    const notes = ['compatibility-only'];
