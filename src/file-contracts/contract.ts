import type { ResearchContract } from '../types.js';
import type { ManagedFileContract } from './shared.js';
import { renderYamlDocument } from './shared.js';

export const QDD_MODE_VALUES = ['human', 'assist', 'auto'] as const;
export const TERMINATION_TYPE_VALUES = ['best_effort'] as const;
...
export function createExampleResearchContract(): ResearchContract {
  return {
...
export const researchContractFileContract: ManagedFileContract = {
  id: 'contract',
  title: 'contract.yaml',
