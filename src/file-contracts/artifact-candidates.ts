import type { ArtifactCandidateManifest } from '../types.js';
...
export function createExampleArtifactCandidateManifest(): ArtifactCandidateManifest {
  return {
    artifact_candidates: [
      {
...
export const artifactCandidateFileContract: ManagedFileContract = {
