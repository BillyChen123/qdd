...
test('qdd conclude harvests mixed positive and negative evidence into evidence_audit', async () => {
  ...
  const taskTwoDocument = await readMarkdownDocument<TaskRecord>(projectRoot, taskTwoPath);
  await writeMarkdownDocument(
    projectRoot,
    taskTwoPath,
    {
  ...
  const studyThreeDocument = await readMarkdownDocument<StudyRecord>(projectRoot, studyThreePath);
  await writeMarkdownDocument(
    projectRoot,
    studyThreePath,
    {
  ...
  const taskThreeDocument = await readMarkdownDocument<TaskRecord>(projectRoot, taskThreePath);
  await writeMarkdownDocument(
    projectRoot,
    taskThreePath,
    {
