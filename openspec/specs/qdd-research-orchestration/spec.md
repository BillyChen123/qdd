# qdd-research-orchestration Specification

## Purpose

Define the research-native QDD orchestration model, including the core filesystem protocol, question evolution semantics, and minimal machine-readable interfaces for status and execution guidance.
