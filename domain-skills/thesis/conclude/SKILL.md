...
description: Manual QDD synthesis skill for turning accumulated project evidence into an auditable manuscript-oriented package. This first-phase scaffold defines the entry surface and PaperSpine vendor provenance only; it does not yet generate story candidates, drafts, or rendered outputs.
---
...
In this phase it holds provenance placeholders only, not upstream source files.
