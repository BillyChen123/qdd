...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generic downstream grouped statistics for spatial AnnData.")
...
def main() -> None:
    ...
    result = {
        "skill": "spatial/spatial-group-stats",
