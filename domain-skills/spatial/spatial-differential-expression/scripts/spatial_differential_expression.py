...
SKILL_NAME = "spatial/spatial-differential-expression"
GROUP_COLUMN = "_qdd_de_group"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Differential expression or differential feature testing for spatial AnnData.")
...
def write_report(report_path: Path, args: argparse.Namespace, matrix_source: str, de: pd.DataFrame, summary: dict[str, Any]) -> None:
    lines = [
        "# spatial-differential-expression report",
        "",
        "## Parameters",
        "",
        "```json",
